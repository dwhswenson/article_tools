 ...
 * Tested on  : Linux + gcc   
 * By         : Sariel Har-Peled 
 * Email      : sariel@math.tau.ac.il, dwhs@hyperblazer.net
 * WEB Page   : http://www.math.tau.ac.il/~sariel/flatex.html (historical)
 *              http://www.hyperblazer.net/flatex
 * Status     : You can do whatever you like with this program. please 
 *              email me bugs & suggestions. (said S.H-P. DWHS agrees with
 *              the first part, but doesn't want your bugs or suggestons.)
 *
 * To do      : Add support to the includeonly command.
 *-----------------------------------------------------------------------
 * FLATEX  1.21, 1994, 1996, by Sariel Har-Peled.
 *         1.30, 2014, modifications by David W.H. Swenson
 *
 ...
 *               -b      Do not insert bibliography file(.bbl)
 *               -B      Always include bibliography file
 *               -o      Output file name
 * 
 ...
 *    ??/?/14, 1.30
 *         * Added -B option to always include bibliography (even if
 *           bibstyle is undefined.)
 *         * Added -o option to allow user to choose output file name
 *
\*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*/
